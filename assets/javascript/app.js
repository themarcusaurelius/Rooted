$(document).ready(function () {
    ...
    //     var selectedValue = $('#price-input', '#housing-input', 'option:selected').val();
    //     var selectedText = $('#price-input', '#housing-input', 'option:selected').val();
    //     $('#price-input', '#housing-input').on("change", function () {
    //         var value = $(this).val();
    //         var text = $(this).find('option:selected').text();
    //     })
